...
use std::{collections::{BTreeSet, HashMap, hash_map::Entry}, sync::{Mutex, LazyLock}};

use three_d::egui::emath::{Float, OrderedFloat};

use crate::process::{DetHashMap, DijkstrasMap, Result, assert_internal};
...
impl Frontier {
    ...
    pub fn get_output(self) -> DijkstrasMap {
        self.map
    }
}